...
///// MASTER SAMD PINS //////////////////////////////////////////////////////////////////////
    ...
    { PORTA,  12, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E), No_ADC_Channel, TC1_CH2, TC1_CH2, EXTERNAL_INT_12 },        // BUS SPI > Compute Module MOSI    /SERCOM_ALT_4_P1.  -> No sure about TC
    { PORTA,  13, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E), No_ADC_Channel, TC1_CH3, TC1_CH3, EXTERNAL_INT_13 },        // BUS SPI > Compute Module SKC     /SERCOM_ALT_4_P0
    { PORTA,  14, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E), No_ADC_Channel, TC1_CH2, TC1_CH4, EXTERNAL_INT_14 },        // BUS SPI > Compute Module CS      /SERCOM_ALT_4_P2
    { PORTA,  15, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E), No_ADC_Channel, TC1_CH3, TC1_CH5, EXTERNAL_INT_15 },        // BUS SPI > Compute Module MISO    /SERCOM_ALT_4_P3
    ...
    { PORTB,   2, PIO_SERCOM_ALT, PIN_ATTR_NONE, ADC_Channel14, TC6_CH0, TC2_CH2, EXTERNAL_INT_2 },               // USB_C PD SDA. ---> not sure if time is correct
    { PORTB,   3, PIO_SERCOM_ALT, PIN_ATTR_NONE, ADC_Channel15, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3  },      // USB_C PD SCL
...
///// SLAVE SAMD PINS ///////////////////////////////////////////////////////////////////////
    ...
    { PORTA,   4, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4 },    // BUS_I2C_SDA    /SERCOM_ALT_0_P0
    { PORTA,   5, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_ANALOG), ADC_Channel7, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 },        // BUS_I2C_SCL    /SERCOM_ALT_0_P1
    { PORTA,   6, PIO_DIGITAL,        EXTERNAL_INT_6 },        // PA06_TOUCH
    { PORTA,   7, PIO_DIGITAL,        EXTERNAL_INT_7 },        // PA07_TOUCH
    { PORTA,   8, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },    // SYNC_IN_1
    { PORTA,   9, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9 },       // SYNC_IN_2
    { PORTA,  10, PIO_DIGITAL,        EXTERNAL_INT_10 },        // PA10_TOUCH
    { PORTA,  11, PIO_DIGITAL,        EXTERNAL_INT_11 },        // PA11_TOUCH
    { PORTA,  12, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E), No_ADC_Channel, TC1_CH2, TC1_CH2, EXTERNAL_INT_12 },        // MIDI_O RX   /SERCOM_ALT_4_P1.  -> not sure if time is correct
    { PORTA,  13, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E), No_ADC_Channel, TC1_CH3, TC1_CH3, EXTERNAL_INT_13 },        // MIDI_0 TX   /SERCOM_ALT_4_P0. -> not sure if time is correc
    ...
    { PORTA,  16, PIO_SERCOM,        EXTERNAL_INT_0 },        // SPI_OLED MOSI   /SERCOM_1_P0 /SERCOM_ALT_3_P1
    { PORTA,  17, PIO_SERCOM,        EXTERNAL_INT_1 },        // SPI_OLED SCK    /SERCOM_1_P1 /SERCOM_ALT_3_P0
    { PORTA,  18, PIO_SERCOM,        EXTERNAL_INT_2 },        // SPI_OLED CS     /SERCOM_1_P2 /SERCOM_ALT_3_P2
    { PORTA,  19, PIO_SERCOM,        EXTERNAL_INT_3 },        // SPI_OLED MISO   /SERCOM_1_P3 /SERCOM_ALT_3_P3
    { PORTA,  20, PIO_DIGITAL,       EXTERNAL_INT_4 },        // PA20_TOUCH
    { PORTA,  21, PIO_DIGITAL,       EXTERNAL_INT_5 },        // PA21_TOUCH
    ...
    { PORTB,   2, PIO_SERCOM_ALT, PIN_ATTR_NONE, ADC_Channel14, TC6_CH0, TC2_CH2, EXTERNAL_INT_2 },             // MIDI_1_TX             ---> not sure if TC is correct
    { PORTB,   3, PIO_SERCOM_ALT, PIN_ATTR_NONE, ADC_Channel15, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 },        // MIDI_1_RX
