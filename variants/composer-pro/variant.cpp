...
///// MASTER SAMD PINS //////////////////////////////////////////////////////////////////////
    ...
    { PORTA,  12, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E), No_ADC_Channel, TC1_CH2, TC1_CH2, EXTERNAL_INT_12 },        // BUS SPI > Compute Module MOSI     /SERCOM_2_P0 /SERCOM_ALT_4_P1
    { PORTA,  13, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E), No_ADC_Channel, TC1_CH3, TC1_CH3, EXTERNAL_INT_13 },        // BUS SPI > Compute Module SKC      /SERCOM_2_P1 /SERCOM_ALT_4_P0
    { PORTA,  14, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E), No_ADC_Channel, TC1_CH2, TC1_CH4, EXTERNAL_INT_14 },        // BUS SPI > Compute Module CS       /SERCOM_2_P2 /SERCOM_ALT_4_P2
    { PORTA,  15, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM_E), No_ADC_Channel, TC1_CH3, TC1_CH5, EXTERNAL_INT_15 },        // BUS SPI > Compute Module MISO     /SERCOM_2_P3 /SERCOM_ALT_4_P3
    ...
    { PORTB,   2, PIO_SERCOM_ALT,        EXTERNAL_INT_2 },        // USB_C PD SDA
    { PORTB,   3, PIO_SERCOM_ALT,                      },        // USB_C PD SCL
...
///// SLAVE SAMD PINS ///////////////////////////////////////////////////////////////////////
    ...
    { PORTA,  12, PIO_SERCOM_ALT,        },        // MIDI_O RX     /SERCOM_2_P0 /SERCOM_ALT_4_P1
    { PORTA,  13, PIO_SERCOM_ALT,        },        // MIDI_0 TX     /SERCOM_2_P1 /SERCOM_ALT_4_P0
    { PORTA,  14, PIO_DIGITAL, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },       // ---
    { PORTA,  15, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },    // OLED DISPLAY D/C
    ...
    { PORTB,   2, PIO_SERCOM_ALT,          EXTERNAL_INT_2 },        // MIDI_1_TX
    { PORTB,   3, PIO_SERCOM_ALT,          EXTERNAL_INT_3 },        // MIDI_1_RX
